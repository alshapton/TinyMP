...
echo "from future import absolute_import" >> conftest.py
...
echo "from future import absolute_import" >> test_storages.py
echo "import umsgpack as msgpack" >> test_storages.py
echo "from tinymp import *" >> test_storages.py

echo "from future import absolute_import" >> test_middlewares.py
